...
/**
 * Test implementation of CertificateValidator for unit testing
 *
 * Uses Java's built-in CertificateFactory for parsing and validation.
 * Does not require Android dependencies.
 */
class TestCertificateValidatorImpl : CertificateValidator {
